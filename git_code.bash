...
#-------------. 13 token
Нажмите Generate new token. Дайте токену имя, например Yandex Practicum. Задайте время жизни токена — 21 день — и уровень доступа к репозиториям: раздел repo и раздел admin:repo_hook должен быть полностью отмечен. После этого нажмите Generate token и скопируйте себе токен, который выдала система. Это и будет ваш пароль. 
Когда будете вводить пароль, символы не будут появляться на экране, так как пароль скрыт. Если имя пользователя и пароль введены верно, коммиты уйдут в GitHub.
Команду git push разберём в следующем уроке. А пока зайдите в удалённый репозиторий на GitHub и обновите страницу.
Код загружен. Теперь к этому репозиторию смогут подключиться другие специалисты. Скоро вы узнаете, как это делать. А пока изучите интерфейс, добавьте вашему репозиторию описание и поупражняйтесь в добавлении файлов в репозиторий.
